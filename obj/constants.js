...
(function() {
  ...
  C1964jsConstants = (function() {
    ...
    function C1964jsConstants() {
      ...
      this.MI_INTR_MASK_SP = 0x01;
      this.MI_INTR_MASK_SI = 0x02;
      this.MI_INTR_MASK_AI = 0x04;
      this.MI_INTR_MASK_VI = 0x08;
      this.MI_INTR_MASK_PI = 0x10;
      this.MI_INTR_MASK_DP = 0x20;
      ...
      this.DPC_STATUS_START_GCLK = 0x008;
      this.DPC_STATUS_TMEM_BUSY = 0x010;
      this.DPC_STATUS_PIPE_BUSY = 0x020;
      this.DPC_STATUS_CMD_BUSY = 0x040;
      this.DPC_STATUS_CBUF_READY = 0x080;
      this.DPC_STATUS_DMA_BUSY = 0x100;
      this.DPC_STATUS_END_VALID = 0x200;
      this.DPC_STATUS_START_VALID = 0x400;
      ...
      this.EXC_WATCH = 92;
      this.EXC_VCED = 124;
      this.CAUSE_IP8 = 0x00008000;
      this.CAUSE_IP7 = 0x00004000;
      this.CAUSE_IP6 = 0x00002000;
      this.CAUSE_IP5 = 0x00001000;
      this.CAUSE_IP4 = 0x00000800;
      this.CAUSE_IP3 = 0x00000400;
      this.CAUSE_SW2 = 0x00000200;
      this.CAUSE_SW1 = 0x00000100;
      ...
      this.TLBLO_CACHMASK = 0x38;
      this.TLBLO_CACHSHIFT = 3;
      this.TLBLO_UNCACHED = 0x10;
      this.TLBLO_NONCOHRNT = 0x18;
      this.TLBLO_EXLWR = 0x28;
      this.TLBLO_D = 0x4;
      this.TLBLO_V = 0x2;
      this.TLBLO_G = 0x1;
      ...
      this.RSP_SPNOOP = 0;
      this.RSP_MTX = 1;
      this.RSP_RESERVED0 = 2;
      this.RSP_MOVEMEM = 3;
      this.RSP_VTX = 4;
      this.RSP_RESERVED1 = 5;
      this.RSP_DL = 6;
      this.RSP_RESERVED2 = 7;
      this.RSP_RESERVED3 = 8;
      this.RSP_SPRITE2D = 9;
      this.RSP_SPRITE2D_BASE = 9;
      this.RSP_1ST = 0xBF;
      ...
      this.RSP_SETOTHERMODE_SHIFT_BLENDMASK = 0;
      ...
      this.RSP_SETOTHERMODE_SHIFT_COLORDITHER = 22;
      ...
      this.RSP_GBI1_MV_MEM_MATRIX_1 = 0x9e;
      ...
      this.RSP_GBI2_MV_MEM__MATRIX = 14;
      ...
      this.RSP_MOVE_WORD_MATRIX = 0x00;
